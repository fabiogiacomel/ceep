...
<body>
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT * FROM EletromecanicaManha WHERE EXISTS (SELECT tbEntrevistaRespostas.cpf FROM tbEntrevistaRespostas WHERE tbEntrevistaRespostas.cpf=EletromecanicaManha.cpf)");
                $stmt->execute();
