          ...
          <div class="card-body">
            <form id="form" name="form1" method="post" action="?pagina=dadosBasicos" onsubmit="return validar()">
              <div class="form-body">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label> <p> Modalidade:</p></br> <p> Alunos que estão cursando o 9º ano devem escolher integrado. 
                      Alunos que estão cursando a 3ª Serie do ensino médio ou concluíram o mesmo devem escolher subseqüente. </p></label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <a href="Edital.pdf" class="float-right">Edital 01/2021</a>
                  </div>
                </div>
