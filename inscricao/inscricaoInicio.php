          ...
          <div class="card-body">
            <form id="form" name="form1" method="post" action="?pagina=dadosBasicos" onsubmit="return validar()">
              <div class="form-body">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label>Modalidade: Alunos que estão cursando o 9º ano devem escolher integrado. Alunos que estão cursando a 3ª Serie do ensino médio ou concluíram devem escolher subseqüente.</label>
