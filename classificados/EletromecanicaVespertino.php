    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-11 col-sm-11 col-md-10 col-lg-10">
                ...
                <h4 class="text-left"> Curso: Eletrômecanica</h4>
        ...
        <div class="container mt-3">
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT nome, cast(pontuacao as unsigned integer) as pontuacao FROM inscricoesValidas WHERE valida=1 AND curso=3 AND periodo = 2 ORDER by pontuacao DESC LIMIT 80");
                $stmt->execute();
