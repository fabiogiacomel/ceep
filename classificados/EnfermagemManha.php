    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-11 col-sm-11 col-md-10 col-lg-10">
                ...
                <h4 class="text-left"> Curso: Técnico em Enfermagem</h4>
                <h4 class="text-left"> Periodo: Manhã (Subsequente)</h4>
            </div>
        </div>
        </div>
        ...
        <div class="container mt-3">
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT nome, cast(pontuacao as unsigned integer) as pontuacao FROM inscricoesValidas WHERE valida=1 AND curso=4 AND periodo = 1 ORDER by pontuacao DESC LIMIT 80");
                $stmt->execute();
