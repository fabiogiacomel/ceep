    ...
    <div class="container">
        ...
        <div class="container mt-3">
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT nome, cast(pontuacao as unsigned integer) as pontuacao FROM inscricoesValidas WHERE valida=1 AND curso=9 AND periodo = 2 ORDER by pontuacao DESC LIMIT 80");
                $stmt->execute();
